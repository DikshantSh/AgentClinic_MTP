...
Evidence: JSL-MedMistral (E2: 50.2\%) has superior medical knowledge but lower TR (0.71). Llama-3.1 (E3: 51.5\%) has superior instruction following and higher TR (0.76). E3 outperforms E2 by 1.3 percentage points.
...
Result: E6 (54.7\%) surpasses both E2 (50.2\%) and E3 (51.5\%), demonstrating that you can have both domain expertise \textit{and} instruction alignment simultaneously through adapter decomposition.
\end{acadbox}
