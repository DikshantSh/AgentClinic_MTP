...
E3 & Llama-3.1-8B & None & 51.5 & 0.63 & 0.76 & 1.02 \\
...
Llama-3.1-8B (E3: 51.5\%) outperformed JSL-MedMistral (E2: 50.2\%) despite having \textit{less} medical domain knowledge. Llama-3.1's superior \textbf{instruction alignment} gave it better command following ($TR = 0.76$ vs.\ 0.71), better multi-turn coherence, and better conditional routing compliance. In interactive clinical simulation, \textit{how well you follow instructions} matters as much as \textit{what you know about medicine}.
